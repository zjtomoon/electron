<template>
    ...
    <div class="main" id="main" @contextmenu.prevent="contextMenuHandler">
        <!-- tab目录结构 -->
        <div class="breadCard">
            <div v-if="menuTabs.length > 1">
                <el-link type="primary">返回上一级</el-link>
                <span class="icon-right">|</span></div>
...
<!--   todo: 全选方法编写  -->
            ...
            <div class="file-box" v-for="(i,index) in fileData" :key="index" :class="{inputChecked: i.checked}"
                ...
                <template v-else>
                    <input type="checkbox" @change.stop="checkedStyle(i, $event)" :checked="i.checked"
        ...
        <div class="file-list" v-else>
            <el-table
                ...
                <el-table-column prop="fileName"
                                 :label="multipleSelection.length === 0 ? '文件名' : '已选中' + multipleSelection.length + '个文件/文件夹'"
                                 width="450">
