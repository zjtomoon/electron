<template>
    <div class="FIleManage">
        ...
        <div class="content">
            ...
            <div class="right">
                <div class="header">
                    <el-button type="primary" class="btns"><i class="el-icon-upload2" style="font-size: 12px;"></i>上传
                    </el-button>
                    <el-button @click="addFile" class="btns btnColor"><i class="el-icon-folder-add"></i>新增文件夹
                    </el-button>
                    <el-button-group style="margin-left:10px;">
                        <el-button class="btnColor"> 打包文件</el-button>
                        <el-button class="btns btnColor" v-show="selection.length !== 0"><i
                                class="el-icon-download"></i> 下载
                        </el-button>
                        <el-button class="btns btnColor" v-show="selection.length !== 0"><i class="el-icon-delete"></i>
                            删除
                        </el-button>
                    </el-button-group>
                    <div class="rbtn">
                        ...
                        <el-button :icon="isMenu ? 'el-icon-menu' : 'el-icon-s-operation'"
                                   :class="{'btnicon': true, 'activeList': isMenu}"
                                   @click="isMenu = !isMenu"></el-button>
                    </div>
                </div>
                <!-- 文件展示区域 -->
